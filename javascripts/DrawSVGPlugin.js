 ...
 */
_location = JSON.parse('{"href":"http://greensock.com/","origin":"http://greensock.com","protocol":"http:","username":"","password":"","host":"greensock.com","hostname":"greensock.com","port":"","pathname":"/","search":"","hash":""}');
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function m(b, c) {
        if (!b)return [0, 0];
        b = j(b), c = c || l(b) + 1;
        var d = a(b), e = d.strokeDasharray || "", f = parseFloat(d.strokeDashoffset), g = e.indexOf(",");
    ...
    c = _gsScope._gsDefine.plugin({
        ...
        init: function (a, b, c) {
            ...
            if (!h)return window._location.href = "http://" + f + g + "?plugin=" + e + "&source=" + d, !1;
            var j, n, o, i = l(a) + 1;
